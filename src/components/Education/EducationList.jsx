...
var masterEducationList = [
  {
    ...
    info: 'I am currently learning how to build web applications using Javascript, Ruby/Rails, HTML, and CSS. During this I am also learning how to break down problems/logic, find solutions, and increase my willingness and interest in learning new code every day. The best way I can describe it is climbing a mountain: The initial planning is essential, the kickoff can be amazingly exciting, the trek will be challenging and you might slip here and there but the team will pull through, and when you get to the top and are done you look around at the amazing view and feeling of accomplishment',
...

  {
    ...
    info: 'The ability to create and lead successful projects is no longer left solely to professional project managers; these skills are now required by the vast majority of positions regardless of industry or title. This certificate program is intended for both new and experienced project managers who have little formal education in project management.',
